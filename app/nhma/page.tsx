...
export default function NHMAPage() {
  ...
  return (
    <Layout showSidebar={false} showHeader={false}>
      <div className="min-h-[calc(100*var(--vh))] bg-gradient-to-b from-[#F5FDFD] to-white dark:from-gray-900 dark:to-gray-800">
        ...
        <div className="container mx-auto px-4 pt-6 mb-8">
          <div className="flex items-center justify-center">
            <Image
              ...
              className="h-auto"
            />
            <span className="mx-6 text-2xl text-gray-400">×</span>
            <Image 
              src="/NHMA Main Logo.png" 
              alt="NHMA Logo" 
              width={128}
              height={51}
              priority
              className="h-auto w-auto object-contain ml-2"
            />
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 pb-8 md:pb-16">
          ...
          <div className="text-center max-w-4xl mx-auto mb-12">
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-8 text-gray-800 dark:text-white">
              Support <span className="text-[#005882] dark:text-[#005882]">National Hispanic Medical Association</span> with Your <span className="text-[#50b4d6] dark:text-[#50b4d6]">Digital Business Card</span>
            </h1>
            <p className="text-lg text-gray-700 dark:text-gray-300 mb-10">
              Support the National Hispanic Medical Association (NHMA) by creating your personalized digital business card. For every lifetime Helix Pro purchase using code NHMA25, a contribution will be made to support NHMA initiatives.
            </p>
            ...
            <div className="mb-8">
              <a
                ...
                className="flex items-center text-[#005882] hover:text-[#004060] font-medium mb-8 justify-center"
              >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-start">
            ...
            <div className="flex flex-col items-center order-1 md:order-1">
              ...
              <div className="flex items-center justify-center mt-6 w-full max-w-md">
                <div className="mr-2 p-1.5 bg-[#005882]/10 rounded-full">
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M21 12L13 4V8C13 8 4 9 4 20C4 20 8 16 13 16V20L21 12Z" stroke="#005882" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                  </svg>
                </div>
                <span className="text-sm text-gray-700 dark:text-gray-300">
                  <span className="font-semibold">Special Offer:</span> Get 10% off Lifetime Helix Pro with code <span className="font-mono bg-gray-100 dark:bg-gray-700 px-1 py-0.5 rounded text-[#005882] font-bold inline-block mt-1">NHMA25</span>
                </span>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-5 md:p-8 order-2 md:order-2 h-full">
              <div>
                <h2 className="text-xl md:text-2xl font-bold mb-4 text-gray-800 dark:text-white flex items-center">
                  <span className="mr-2 text-[#50b4d6]">🎁</span>
                  Redeem Your Helix Pro Discount
                </h2>
                
                <div className="space-y-6">
                  <div>
                    <div className="bg-[#005882]/10 p-4 rounded-lg border border-[#005882]/30 mb-6">
                      <div className="flex flex-col sm:flex-row items-start">
                        <div className="bg-[#005882] text-white h-8 px-3 rounded-lg flex items-center justify-center mr-3 mb-3 sm:mb-0 font-bold text-sm">
                          EXCLUSIVE
                        </div>
                        <p className="text-gray-700 dark:text-gray-300 text-sm md:text-base">
                          As a National Hispanic Medical Association supporter, you get 10% off Lifetime Helix Pro with code: <span className="font-mono bg-gray-100 dark:bg-gray-700 px-2 py-1 rounded text-[#005882] font-bold inline-block mt-1">NHMA25</span>
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    <div className="bg-[#005882] text-white w-8 h-8 rounded-full flex items-center justify-center mr-4 flex-shrink-0 font-bold">
                      1
                    </div>
                    <div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 dark:text-gray-300 text-sm md:text-base">
                        Click the &quot;Get Helix Pro&quot; tab in the menu or go directly to <a href="https://www.helixcard.app/get-helix-pro" target="_blank" rel="noopener noreferrer" className="text-[#005882] underline">www.helixcard.app/get-helix-pro</a>
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 dark:text-gray-300 text-sm md:text-base">
                        Find the &quot;Coupon Code&quot; field and enter <span className="font-mono bg-gray-100 dark:bg-gray-700 px-1.5 py-0.5 rounded text-[#005882] font-bold">NHMA25</span>
                      </p>
                    </div>
                  </div>
                  
                  <div className="pt-4">
                    <div className="bg-[#F5FDFD] dark:bg-gray-700 p-4 rounded-lg border border-[#005882]/30">
                      <p className="text-sm text-gray-600 dark:text-gray-300">
                        <span className="font-bold">Important:</span> You must visit <a href="https://www.helixcard.app/get-helix-pro" target="_blank" rel="noopener noreferrer" className="text-[#005882] underline">www.helixcard.app/get-helix-pro</a> to redeem the code, not the app. Use the same login method you used to create your account. Remember to select the Lifetime plan to receive your 10% discount.
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 md:p-8 order-3 md:order-3 h-full">
              ...
              <p className="text-gray-600 dark:text-gray-300 text-sm md:text-base mb-6">
                Attendees of NHMA Annual Conference will receive a physical NFC card and can be used to connect to a digital business card.
              </p>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 md:p-8 order-4 md:order-4 h-full">
              <h2 className="text-2xl font-bold mb-4 text-gray-800 dark:text-white flex items-center">
                <span className="inline-block mr-3 text-[#005882]">📱</span> How NFC Cards Work
              </h2>
              ...
              <div className="bg-[#F5FDFD] dark:bg-gray-700 p-5 rounded-lg border border-gray-200 dark:border-gray-600 mb-6">
                <h3 className="font-medium text-gray-800 dark:text-white mb-3">For different devices:</h3>
                <ul className="space-y-3">
                  <li className="flex items-center">
                    <div className="bg-[#005882] text-white w-6 h-6 rounded-full flex items-center justify-center mr-3 flex-shrink-0">
                      <svg width="12" height="12" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M5 13l4 4L19 7" stroke="white" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"/>
                      </svg>
                    </div>
                    <p className="text-gray-700 dark:text-gray-300">
                      <span className="font-bold">iPhone users:</span> Tap the top of your phone to the NFC card
                    </p>
                  </li>
                  <li className="flex items-center">
                    <div className="bg-[#005882] text-white w-6 h-6 rounded-full flex items-center justify-center mr-3 flex-shrink-0">
                    ...
                    <p className="text-gray-700 dark:text-gray-300">
                      <span className="font-bold">Android users:</span> Tap the back/center of your phone to the NFC card
                    </p>
                  </li>
                </ul>
              </div>

              <h3 className="font-medium text-gray-800 dark:text-white mb-3">What happens when someone taps your card:</h3>
              <ol className="space-y-3">
                <li className="flex items-center">
                  <div className="bg-[#005882] text-white w-6 h-6 rounded-full flex items-center justify-center mr-3 flex-shrink-0 font-medium">
                    1
                  </div>
                  <p className="text-gray-700 dark:text-gray-300">
        ...
        <div className="py-12 bg-white dark:bg-gray-800">
          <div className="container mx-auto px-4">
            ...
            <p className="text-gray-600 dark:text-gray-300 text-center mb-10 max-w-3xl mx-auto">
              Helix gives you a powerful, professional way to share your contact information and support National Hispanic Medical Association at the same time.
            </p>
            
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
              <div className="bg-[#F5FDFD] dark:bg-gray-700 p-6 rounded-xl text-center">
                <div className="bg-[#50b4d6] dark:bg-[#50b4d6] w-16 h-16 mx-auto mb-4 rounded-full flex items-center justify-center">
              ...
              <div className="bg-[#F5FDFD] dark:bg-gray-700 p-6 rounded-xl text-center">
                <div className="bg-[#005882] dark:bg-[#005882] w-16 h-16 mx-auto mb-4 rounded-full flex items-center justify-center">
              ...
              <div className="bg-[#F5FDFD] dark:bg-gray-700 p-6 rounded-xl text-center">
                ...
                <h3 className="text-xl font-semibold mb-3 text-gray-800 dark:text-white">Support NHMA</h3>
                <p className="text-gray-600 dark:text-gray-300">For every card created with our special code, we&apos;ll make a contribution to National Hispanic Medical Association initiatives.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        {/* CTA Section */}
        <div className="bg-[#005882] dark:bg-[#005882] py-12 text-white">
          <div className="container mx-auto px-4 text-center">
            <h2 className="text-2xl md:text-3xl font-bold mb-6">Ready to Support NHMA?</h2>
            <p className="text-xl mb-8 max-w-3xl mx-auto">
              Create your digital business card today and help contribute to National Hispanic Medical Association initiatives.
            </p>
