...
export const RegisterForm: React.FC<RegisterFormProps> = ({ onSuccess }) => {
  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      <button
        type="submit"
        className="w-full py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-dark-pink hover:bg-red focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red"
      >
        Sign up
      </button>
    </form>
