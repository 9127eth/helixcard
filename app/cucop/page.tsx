...
export default function CucopPage() {
  ...
  return (
    <Layout showSidebar={false} showHeader={false}>
      <div className="min-h-[calc(100*var(--vh))] bg-gradient-to-b from-[#F5FDFD] to-white dark:from-gray-900 dark:to-gray-800">
        ...
        <div className="container mx-auto px-4 pb-8 md:pb-16">
          ...
          <div className="text-center max-w-4xl mx-auto mb-12">
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-8 text-gray-800 dark:text-white">
              Support <span className="text-black dark:text-[#CFB87C]">CU Anschutz Skaggs APhA</span> with Your <span className="text-[#CFB87C] dark:text-[#CFB87C]">Digital Business Card</span>
            </h1>
            <p className="text-lg text-gray-700 dark:text-gray-300 mb-10">
              Join your local American Pharmacists Association (APhA) fundraiser by creating your personalized digital business card. For every lifetime Helix Pro purchase using code CUCOP@%, a contribution will be made to support the CU Anschutz Skaggs School of Pharmacy APhA chapter.
            </p>
            
            <div className="flex flex-col sm:flex-row gap-4 mb-4 justify-center">
              <a 
                href="/?source=cucop#auth"
                className="px-6 py-3 bg-black hover:bg-[#1a1a1a] text-white font-medium rounded-lg flex items-center justify-center transition-colors duration-300"
              >
                Get Started
            ...
            <div className="mb-8">
              <a
                ...
                className="flex items-center text-black hover:text-[#565A5C] font-medium mb-8 justify-center"
              >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-start">
            ...
            <div className="flex flex-col items-center order-1 md:order-1">
              ...
              <div className="flex items-center justify-center mt-6 w-full max-w-md">
                <div className="mr-2 p-1.5 bg-black/10 rounded-full">
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M21 12L13 4V8C13 8 4 9 4 20C4 20 8 16 13 16V20L21 12Z" stroke="#000000" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                  </svg>
                </div>
                <span className="text-sm text-gray-700 dark:text-gray-300">
                  <span className="font-semibold">Support Skaggs APhA:</span> Use code <span className="font-mono bg-gray-100 dark:bg-gray-700 px-1 py-0.5 rounded text-black font-bold inline-block mt-1">CUCOP@%</span> on a Lifetime Helix Pro purchase so we can attribute your contribution
                </span>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-5 md:p-8 order-2 md:order-2 h-full">
              <div>
                <h2 className="text-xl md:text-2xl font-bold mb-4 text-gray-800 dark:text-white flex items-center">
                  <span className="mr-2 text-[#CFB87C]">🎁</span>
                  Use Your Helix Pro Code
                </h2>
                
                <div className="space-y-6">
                  <div>
                    <div className="bg-black/10 p-4 rounded-lg border border-black/30 mb-6">
                      <div className="flex flex-col sm:flex-row items-start">
                        <div className="bg-black text-white h-8 px-3 rounded-lg flex items-center justify-center mr-3 mb-3 sm:mb-0 font-bold text-sm">
                          EXCLUSIVE
                        </div>
                        <p className="text-gray-700 dark:text-gray-300 text-sm md:text-base">
                          As a CU Anschutz Skaggs APhA fundraiser supporter, enter code <span className="font-mono bg-gray-100 dark:bg-gray-700 px-2 py-1 rounded text-black font-bold inline-block mt-1">CUCOP@%</span> on a Lifetime Helix Pro purchase so we can track your contribution. Regular pricing applies.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    <div className="bg-black text-white w-8 h-8 rounded-full flex items-center justify-center mr-4 flex-shrink-0 font-bold">
                      1
                    </div>
                    <div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 dark:text-gray-300 text-sm md:text-base">
                        Click the &quot;Get Helix Pro&quot; tab in the menu or go directly to <a href="https://www.helixcard.app/get-helix-pro" target="_blank" rel="noopener noreferrer" className="text-black underline">www.helixcard.app/get-helix-pro</a>
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 dark:text-gray-300 text-sm md:text-base">
                        Make sure to select the <span className="font-medium">Lifetime</span> plan option (this code only applies to the Lifetime plan)
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 dark:text-gray-300 text-sm md:text-base">
                        Find the &quot;Coupon Code&quot; field and enter <span className="font-mono bg-gray-100 dark:bg-gray-700 px-1.5 py-0.5 rounded text-black font-bold">CUCOP@%</span>
                      </p>
                    </div>
                  </div>
                  
                  <div className="pt-4">
                    <div className="bg-[#F5FDFD] dark:bg-gray-700 p-4 rounded-lg border border-black/30">
                      <p className="text-sm text-gray-600 dark:text-gray-300">
                        <span className="font-bold">Important:</span> You must visit <a href="https://www.helixcard.app/get-helix-pro" target="_blank" rel="noopener noreferrer" className="text-black underline">www.helixcard.app/get-helix-pro</a> to redeem the code, not the app. Use the same login method you used to create your account. Remember to select the Lifetime plan so your purchase can be attributed.
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 md:p-8 order-3 md:order-3 h-full">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start">
                  <div className="bg-[#CFB87C] text-black w-8 h-8 rounded-full flex items-center justify-center mr-4 flex-shrink-0 font-bold">
                    4
                  </div>
                  <div>
              ...
              <div className="space-y-5">
                ...
                <div className="bg-[#F5FDFD] dark:bg-gray-700 p-4 rounded-lg border border-black/30">
                  ...
                  <ul className="space-y-3">
                    <li className="flex items-start">
                      <div className="bg-black text-white w-6 h-6 rounded-full flex items-center justify-center mr-3 flex-shrink-0 text-sm">
                ...
                <div className="space-y-3">
                  ...
                  <ol className="space-y-3">
                    <li className="flex items-start">
                      <div className="bg-black text-white w-6 h-6 rounded-full flex items-center justify-center mr-3 flex-shrink-0 text-sm font-medium">
                        1
                      </div>
                      <p className="text-gray-600 dark:text-gray-300 text-sm">
        ...
        <div className="py-12 bg-white dark:bg-gray-800">
          <div className="container mx-auto px-4">
            ...
            <p className="text-gray-600 dark:text-gray-300 text-center mb-10 max-w-3xl mx-auto">
              Helix gives you a powerful, professional way to share your contact information and support the CU Anschutz Skaggs School of Pharmacy APhA chapter at the same time.
            </p>
            
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
              <div className="bg-[#F5FDFD] dark:bg-gray-700 p-6 rounded-xl text-center">
                <div className="bg-[#CFB87C] dark:bg-[#CFB87C] w-16 h-16 mx-auto mb-4 rounded-full flex items-center justify-center">
                  <FaMagic className="text-black dark:text-black text-2xl" />
                </div>
              ...
              <div className="bg-[#F5FDFD] dark:bg-gray-700 p-6 rounded-xl text-center">
                <div className="bg-black dark:bg-black w-16 h-16 mx-auto mb-4 rounded-full flex items-center justify-center">
              ...
              <div className="bg-[#F5FDFD] dark:bg-gray-700 p-6 rounded-xl text-center">
                <div className="bg-[#CFB87C] dark:bg-[#CFB87C] w-16 h-16 mx-auto mb-4 rounded-full flex items-center justify-center">
                  <Users className="text-black dark:text-black text-2xl" />
                </div>
                <h3 className="text-xl font-semibold mb-3 text-gray-800 dark:text-white">Support Skaggs APhA</h3>
                <p className="text-gray-600 dark:text-gray-300">For every card created with our special code, we&apos;ll make a contribution to the CU Anschutz Skaggs School of Pharmacy APhA chapter.</p>
              </div>
            </div>
          </div>
        </div>
              ...
              <div className="bg-white dark:bg-gray-700 p-5 rounded-2xl shadow-md hover:shadow-lg transition-shadow">
                <div className="flex items-center mb-3">
                  <div className="w-12 h-12 bg-yellow-100 dark:bg-yellow-900 rounded-full flex items-center justify-center mr-4">
                    <span className="text-yellow-700 dark:text-yellow-300 font-bold">SP</span>
                  </div>
                  <div>
                ...
                <p className="text-gray-600 dark:text-gray-300">&quot;I love that I can support Skaggs APhA while also getting a useful networking tool. The NFC feature is amazing - no more fumbling with paper cards!&quot;</p>
                <div className="flex mt-4">
                  {[1, 2, 3, 4, 5].map((star) => (
                    <svg key={star} className="w-5 h-5 text-yellow-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                      <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"></path>
              ...
              <div className="bg-white dark:bg-gray-700 p-5 rounded-2xl shadow-md hover:shadow-lg transition-shadow">
                <div className="flex items-center mb-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500 dark:text-gray-400">CU Anschutz Alumnus</p>
                  </div>
                </div>
        ...
        {/* CTA Section */}
        <div className="bg-black dark:bg-black py-12 text-white">
          <div className="container mx-auto px-4 text-center">
            <h2 className="text-2xl md:text-3xl font-bold mb-6">Ready to Support CU Anschutz Skaggs APhA?</h2>
            <p className="text-xl mb-8 max-w-3xl mx-auto">
              Create your digital business card today and help contribute to the CU Anschutz Skaggs School of Pharmacy American Pharmacists Association chapter.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a 
                href="/?source=cucop#auth"
                className="px-6 py-3 bg-white text-black hover:bg-gray-100 font-medium rounded-lg flex items-center justify-center transition-colors duration-300 sm:w-auto"
              >
                Get Started
                <FaArrowRight className="ml-2" />
              </a>
