        ...
        <div className="container mx-auto px-4 pb-8 md:pb-16">
          ...
          <div className="text-center max-w-4xl mx-auto mb-12">
            ...
            <p className="text-lg text-gray-700 dark:text-gray-300 mb-10">
              Join your local American Pharmacists Association (APhA) fundraiser by creating your personalized digital business card. For every lifetime Helix Pro purchase using code UTTYLER25, a contribution will be made to support UT Tyler&apos;s local APhA chapter.
            </p>
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 dark:text-gray-300 text-sm md:text-base">
                        Click the &quot;Get Helix Pro&quot; tab in the menu or go directly to <a href="https://www.helixcard.app/get-helix-pro" target="_blank" rel="noopener noreferrer" className="text-[#00377B] underline">www.helixcard.app/get-helix-pro</a>
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="pt-4">
                    <div className="bg-[#F5FDFD] dark:bg-gray-700 p-4 rounded-lg border border-[#00377B]/30">
                      <p className="text-sm text-gray-600 dark:text-gray-300">
                        <span className="font-bold">Important:</span> You must visit <a href="https://www.helixcard.app/get-helix-pro" target="_blank" rel="noopener noreferrer" className="text-[#00377B] underline">www.helixcard.app/get-helix-pro</a> to redeem the code, not the app. Use the same login method you used to create your account. Remember to select the Lifetime plan to receive your 10% discount.
                      </p>
                    </div>
                  </div>
                </div>
